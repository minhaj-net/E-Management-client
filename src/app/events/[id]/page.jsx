...
export default function EventDetailsPage() {
  ...
  const handleBookNow = async () => {
    ...
    const alreadyBook = bookedEvent.some((c) => c.BookId === eventData._id);
    if (alreadyBook) {
    ...
    try {
      const res = await fetch("https://e-managment-green.vercel.app/my-bookedEvent", {
        method: "POST",
    ...
    // try {
    //   await axios.post(
    //     "https://https://e-managment-green.vercel.app/my-bookedEvent",
    //     bookedData
    //   );
    //   toast.success("✅ Booked successfully!");
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(`https://e-managment-green.vercel.app/events/${id}`)
      .then((res) => {
